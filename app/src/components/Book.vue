<template>
    <div class="book">
        ...
        <!-- read more toggle -->
        <p v-if="!readMoreCliked" class="book__description">{{ description.slice(0, 300) }} <button @click="toggleReadMore" class="book__description-readmore">[...Read more]</button></p> 
        ...
        <p class="book__rating">
            <svg v-if="rating == 1" width="diceForm" height="diceForm" viewBox="0 0 88 88" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg v-if="rating ==2" width="diceForm" height="diceForm" viewBox="0 0 88 88" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg v-if="rating == 3" width="diceForm" height="diceForm" viewBox="0 0 88 88" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg v-if="rating == 4" width="diceForm" height="diceForm" viewBox="0 0 88 88" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg v-if="rating == 5" width="diceForm" height="diceForm" viewBox="0 0 88 88" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg v-if="rating == 6" width="diceForm" height="diceForm" viewBox="0 0 88 88" fill="none" xmlns="http://www.w3.org/2000/svg">
