<template>
    <header class="header">
        <Router-Link :to="{ name: 'dashboard', params: {name: 'dashboard'} }" class="header__logo">
    ...
    export default {
        ...
        methods: {
            async logOut() {
                ...
                this.$router.push('/dashboard') // reload page, after logged out
            },
